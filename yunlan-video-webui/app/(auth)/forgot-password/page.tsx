...
function ForgotPasswordContent() {
  ...
  return (
    ...
    >
            ...
            <button
              ...
              className={cn(
                ...
                resetType === "email"
                  ...
                  : "bg-transparent text-muted-foreground/80 border-border/30 hover:border-primary/40"
              )}
            >
              邮箱链接找回
            </button>
      ...
      {step === "success_message" && (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full rounded-full border border-border/30 text-foreground py-3 hover:bg-foreground/5 transition-all text-sm font-medium"
          >
            重新申请
          </button>
        </div>
      ...
      <p className="text-xs text-muted-foreground/60 pt-8">云揽镜 · AI视频创作平台</p>
    </AuthLayout>
  );
}
