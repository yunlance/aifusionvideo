  ...
  return (
    ...
    >
      ...
      <button
        onClick={onDelete}
        disabled={isDemo}
        className="p-1.5 mr-1 flex items-center shrink-0 rounded-full opacity-0 group-hover/scene:opacity-100 text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
        title={isDemo ? "演示数据不可删除" : "删除场次"}
      >
            ...
            <div key={ep.id} className="group/ep mb-0.5">
              ...
              >
                ...
                <button
                  ...
                  disabled={isDemo}
                  className="p-1.5 mr-1 shrink-0 rounded-full opacity-0 group-hover/ep:opacity-100 text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  title={isDemo ? "演示数据不可删除" : "删除分集"}
                >
                  <Trash2 className="h-3 w-3" />
                </button>
              </div>
