...
const COLUMNS: ColumnDef[] = [
  ...
  { label: "关联素材", field: "assets", initW: 160, minW: 100 },
                    ...
                    <TooltipTrigger
                      render={
                        <button
                          ...
                          disabled={isDemo}
                          className="p-1 rounded opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                          title={isDemo ? "演示数据不可删除" : "删除镜头"}
                        >
